...
(function (root) {
  ...
  function wrapLibrary(Module) {
    Module["crypto_auth_hmacsha256_BYTES"] = Module.cwrap("opaquejs_crypto_auth_hmacsha256_BYTES", "number")();
    Module["crypto_core_ristretto255_BYTES"] = Module.cwrap("opaquejs_crypto_core_ristretto255_BYTES", "number")();
    Module["crypto_hash_sha256_BYTES"] = Module.cwrap("opaquejs_crypto_hash_sha256_BYTES", "number")();
    Module["crypto_scalarmult_BYTES"] = Module.cwrap("opaquejs_crypto_scalarmult_BYTES", "number")();
    Module["crypto_scalarmult_SCALARBYTES"] = Module.cwrap("opaquejs_crypto_scalarmult_SCALARBYTES", "number")();
    Module["crypto_secretbox_KEYBYTES"] = Module.cwrap("opaquejs_crypto_secretbox_KEYBYTES", "number")();
    Module["OPAQUE_USER_RECORD_LEN"] = Module.cwrap("opaquejs_OPAQUE_USER_RECORD_LEN", "number")();
    Module["OPAQUE_REGISTER_PUBLIC_LEN"] = Module.cwrap("opaquejs_OPAQUE_REGISTER_PUBLIC_LEN", "number")();
    Module["OPAQUE_REGISTER_SECRET_LEN"] = Module.cwrap("opaquejs_OPAQUE_REGISTER_SECRET_LEN", "number")();
    Module["OPAQUE_SERVER_SESSION_LEN"] = Module.cwrap("opaquejs_OPAQUE_SERVER_SESSION_LEN", "number")();
    Module["OPAQUE_REGISTER_USER_SEC_LEN"] = Module.cwrap("opaquejs_OPAQUE_REGISTER_USER_SEC_LEN", "number")();
    Module["OPAQUE_USER_SESSION_PUBLIC_LEN"] = Module.cwrap("opaquejs_OPAQUE_USER_SESSION_PUBLIC_LEN", "number")();
    Module["OPAQUE_USER_SESSION_SECRET_LEN"] = Module.cwrap("opaquejs_OPAQUE_USER_SESSION_SECRET_LEN", "number")();
    Module["OPAQUE_SERVER_AUTH_CTX_LEN"] = Module.cwrap("opaquejs_OPAQUE_SERVER_AUTH_CTX_LEN", "number")();
    Module["NotPackaged"] = 0;
    Module["InSecEnv"] = 1;
    Module["InClrEnv"] = 2;

    Module["genServerKeyPair"] = function () {
      return genServerKeyPair(Module);
    };

    Module["GenServerKeyPair"] = Module.cwrap("opaquejs_GenServerKeyPair", "number", ["number", // uint8_t pkS[crypto_scalarmult_BYTES]
    ...
    function genServerKeyPair(module) {
      ...
      try {
        var pkS_pointer = new AllocatedBuf(module.crypto_scalarmult_BYTES, module);
        pointers.push(pkS_pointer);
        var skS_pointer = new AllocatedBuf(module.crypto_scalarmult_SCALARBYTES, module);
        pointers.push(skS_pointer);

        if (0 !== module.GenServerKeyPair(pkS_pointer.address, skS_pointer.address)) {
          var error = new Error("GenServerKeyPair failed.");
        ...
        var _error = new Error("genServerKeyPair failed. (" + e.name + ") " + e.message);

        _error.name = "OpaqueError";
        _error.cause = e;
        throw _error;
      } finally {
    ...
    Module["register"] = function (params) {
      return register(Module, params);
    };

    Module["Register"] = Module.cwrap("opaquejs_Register", "number", ["string", // const uint8_t *pwdU,
    ...
    function register(module, params) {
      ...
      try {
        ...
        if (skS != null) {
          ...
          skS_pointer = AllocatedBuf.fromUint8Array(skS, module.crypto_scalarmult_SCALARBYTES, module);
          pointers.push(skS_pointer);
        }

        var envU_len = module.getEnvelopeLen({
          cfg: cfg,
          ids: ids
        });
        var rec_pointer = new AllocatedBuf(module.OPAQUE_USER_RECORD_LEN + envU_len, module);
        ...
        if (0 !== module.Register(pwdU, pwdU_len, skS_pointer ? skS_pointer.address : null, cfg.skU, cfg.pkU, cfg.pkS, cfg.idS, cfg.idU, ids.idU, ids.idU.length, ids.idS, ids.idS.length, rec_pointer.address, export_key_pointer.address)) {
        ...
        var _error2 = new Error("register failed. (" + e.name + ") " + e.message);

        _error2.name = "OpaqueError";
        _error2.cause = e;
        throw _error2;
      } finally {
        zeroAndFree(pointers);
    ...
    Module["createCredentialRequest"] = function (params) {
      return createCredentialRequest(Module, params);
    };

    Module["CreateCredentialRequest"] = Module.cwrap("opaquejs_CreateCredentialRequest", "number", ["string", // const uint8_t *pwdU,
    "number", // const uint16_t pwdU_len,
    ...
    function createCredentialRequest(module, params) {
      ...
      try {
        var pwdU = params.pwdU; // required

        validateRequiredStrings({
          pwdU: pwdU
        });
        var pwdU_len = pwdU.length;
        var sec_pointer = new AllocatedBuf(module.OPAQUE_USER_SESSION_SECRET_LEN + pwdU.length, module);
        pointers.push(sec_pointer);
        var pub_pointer = new AllocatedBuf(module.OPAQUE_USER_SESSION_PUBLIC_LEN, module);
        pointers.push(pub_pointer);

        if (0 !== module.CreateCredentialRequest(pwdU, pwdU_len, sec_pointer.address, pub_pointer.address)) {
          var error = new Error("CreateCredentialRequest failed.");
          error.name = "OpaqueError";
          throw error;
        }
        ...
        var _error3 = new Error("createCredentialRequest failed. (" + e.name + ") " + e.message);

        _error3.name = "OpaqueError";
        _error3.cause = e;
        throw _error3;
      } finally {
        zeroAndFree(pointers);
    ...
    Module["createCredentialResponse"] = function (params) {
      return createCredentialResponse(Module, params);
    };

    Module["CreateCredentialResponse"] = Module.cwrap("opaquejs_CreateCredentialResponse", "number", ["number", // const uint8_t pub[OPAQUE_USER_SESSION_PUBLIC_LEN],
    ...
    function createCredentialResponse(module, params) {
      ...
      try {
        ...
        validatePkgConfig(cfg);
        var pub_pointer = AllocatedBuf.fromUint8Array(pub, module.OPAQUE_USER_SESSION_PUBLIC_LEN, module);
        pointers.push(pub_pointer);
        var envU_len = module.getEnvelopeLen({
          cfg: cfg,
          ids: ids
        });
        var rec_pointer = AllocatedBuf.fromUint8Array(rec, module.OPAQUE_USER_RECORD_LEN + envU_len, module);
        pointers.push(rec_pointer);
        var resp_pointer = new AllocatedBuf(module.OPAQUE_SERVER_SESSION_LEN + envU_len, module);
        pointers.push(resp_pointer);
        var sk_pointer = new AllocatedBuf(module.crypto_secretbox_KEYBYTES, module);
        pointers.push(sk_pointer);
        var sec_pointer = new AllocatedBuf(module.OPAQUE_SERVER_AUTH_CTX_LEN, module);
        pointers.push(sec_pointer);
        sec_pointer.zero();
        ...
        var _error4 = new Error("createCredentialResponse failed. (" + e.name + ") " + e.message);

        _error4.name = "OpaqueError";
        _error4.cause = e;
        throw _error4;
      } finally {
        zeroAndFree(pointers);
    ...
    Module["recoverCredentials"] = function (params) {
      return recoverCredentials(Module, params);
    };

    Module["RecoverCredentials"] = Module.cwrap("opaquejs_RecoverCredentials", "number", ["number", // const uint8_t resp[OPAQUE_SERVER_SESSION_LEN/*+envU_len*/],
    ...
    function recoverCredentials(module, params) {
      ...
      try {
        var resp = params.resp,
            ...
            infos = params.infos,
            ids = params.ids,
            max_ids_idU_len = params.max_ids_idU_len,
            max_ids_idS_len = params.max_ids_idS_len;
        var app_info = infos || {};
        validateUint8Arrays({
          resp: resp,
          sec: sec
        ...
        validateOptionalStrings(app_info);
        validatePkgConfig(cfg);
        var resp_pointer = AllocatedBuf.fromUint8ArrayInexact(resp, module.OPAQUE_SERVER_SESSION_LEN
        /*+envU_len*/
        , module);
        pointers.push(resp_pointer);
        var sec_pointer = AllocatedBuf.fromUint8ArrayInexact(sec, module.OPAQUE_USER_SESSION_SECRET_LEN
        /*+pwdU_len*/
        , module);
        pointers.push(sec_pointer);
        var pkS_pointer;
        ...
        if (cfg.pkS == module.NotPackaged) {
          ...
          pkS_pointer = AllocatedBuf.fromUint8Array(pkS, module.crypto_scalarmult_BYTES, module);
          pointers.push(pkS_pointer);
        } // uint16_t has 16 bits = 2 bytes.


        var ids1_idU_len_pointer = new AllocatedBuf(2, module);
        pointers.push(ids1_idU_len_pointer);
        var ids1_idS_len_pointer = new AllocatedBuf(2, module);
        pointers.push(ids1_idS_len_pointer); // 32 bits handles the maximum memory size in bytes (2 GB = 2147483648
        // bytes). See
        // https://github.com/emscripten-core/emscripten/blob/2.0.11/src/settings.js .
        // 32 bits = 4 bytes.

        var ids1_idU_pointer_pointer = new AllocatedBuf(4, module);
        pointers.push(ids1_idU_pointer_pointer);
        var ids1_idS_pointer_pointer = new AllocatedBuf(4, module);
        pointers.push(ids1_idS_pointer_pointer); // If the IDs are not in the envelope, we must provide them beforehand. If
        // they are in the envelope, we use the IDs in the envelope.

        var ids1_idU_pointer;

        if (cfg.idU === module.NotPackaged) {
          validateRequiredStrings({
            ids_idU: ids.idU
          });
          module.setValue(ids1_idU_len_pointer.address, ids.idU.length, "i16"); // ccall uses stringToUTF8 for string arguments. See
          ...
          ids1_idU_pointer = new AllocatedBuf((ids.idU.length << 2) + 1, module);
          pointers.push(ids1_idU_pointer);
          module.stringToUTF8(ids.idU, ids1_idU_pointer.address, ids1_idU_pointer.length);
        } else {
          // ids1_idU_pointer must be big enough to fit idU.
          var ids1_idU_len = Number.isInteger(max_ids_idU_len) && max_ids_idU_len > 0 ? max_ids_idU_len : 64;
          module.setValue(ids1_idU_len_pointer.address, ids1_idU_len, "i16");
          ids1_idU_pointer = new AllocatedBuf(ids1_idU_len, module);
          pointers.push(ids1_idU_pointer);
        }

        module.setValue(ids1_idU_pointer_pointer.address, ids1_idU_pointer.address, "i32");
        var ids1_idS_pointer;

        if (cfg.idS === module.NotPackaged) {
          validateRequiredStrings({
            ids_idS: ids.idS
          });
          var ids_idS_len = ids.idS.length;
          module.setValue(ids1_idS_len_pointer.address, ids_idS_len, "i16"); // ccall uses stringToUTF8 for string arguments. See
          // https://github.com/emscripten-core/emscripten/blob/2.0.11/src/preamble.js.
          // At most there are 4 bytes per UTF-8 code point. Add +1 for the
          // trailing '\0'.

          ids1_idS_pointer = new AllocatedBuf((ids.idS.length << 2) + 1, module);
          pointers.push(ids1_idS_pointer);
          module.stringToUTF8(ids.idS, ids1_idS_pointer.address, ids1_idS_pointer.length);
        } else {
          // ids1_idS_pointer must be big enough to fit idS.
          var ids1_idS_len = Number.isInteger(max_ids_idS_len) && max_ids_idS_len > 0 ? max_ids_idS_len : 64;
          module.setValue(ids1_idS_len_pointer.address, ids1_idS_len, "i16");
          ids1_idS_pointer = new AllocatedBuf(ids1_idS_len, module);
          pointers.push(ids1_idS_pointer);
        }

        module.setValue(ids1_idS_pointer_pointer.address, ids1_idS_pointer.address, "i32");
        var sk_pointer = new AllocatedBuf(module.crypto_secretbox_KEYBYTES, module);
        pointers.push(sk_pointer);
        var authU_pointer = new AllocatedBuf(module.crypto_auth_hmacsha256_BYTES, module);
        ...
        return {
          ids: {
            idU: module.UTF8ToString(ids1_idU_pointer.address, module.getValue(ids1_idU_len_pointer.address, "i16")),
            idS: module.UTF8ToString(ids1_idS_pointer.address, module.getValue(ids1_idS_len_pointer.address, "i16"))
          },
          sk: sk_pointer.toUint8Array(),
        ...
        var _error5 = new Error("recoverCredentials failed. (" + e.name + ") " + e.message);

        _error5.name = "OpaqueError";
        _error5.cause = e;
        throw _error5;
      } finally {
        zeroAndFree(pointers);
    ...
    Module["userAuth"] = function (params) {
    ...
    Module["createRegistrationRequest"] = function (params) {
      return createRegistrationRequest(Module, params);
    };

    Module["CreateRegistrationRequest"] = Module.cwrap("opaquejs_CreateRegistrationRequest", "number", ["string", // const uint8_t *pwdU,
    "number", // const uint16_t pwdU_len,
    ...
    function createRegistrationRequest(module, params) {
      ...
      try {
        ...
        var pwdU_len = pwdU.length;
        var sec_pointer = new AllocatedBuf(module.OPAQUE_REGISTER_USER_SEC_LEN + pwdU_len, module);
        pointers.push(sec_pointer);
        var M_pointer = new AllocatedBuf(module.crypto_core_ristretto255_BYTES, module);
        pointers.push(M_pointer);

        if (0 !== module.CreateRegistrationRequest(pwdU, pwdU_len, sec_pointer.address, M_pointer.address)) {
          var error = new Error("CreateRegistrationRequest failed.");
          error.name = "OpaqueError";
          throw error;
        }
        ...
        var _error6 = new Error("createRegistrationRequest failed. (" + e.name + ") " + e.message);

        _error6.name = "OpaqueError";
        _error6.cause = e;
        throw _error6;
      } finally {
        zeroAndFree(pointers);
    ...
    Module["createRegistrationResponse"] = function (params) {
      return createRegistrationResponse(Module, params);
    };

    Module["CreateRegistrationResponse"] = Module.cwrap("opaquejs_CreateRegistrationResponse", "number", ["number", // const uint8_t M[crypto_core_ristretto255_BYTES],
    ...
    function createRegistrationResponse(module, params) {
      ...
      try {
        var M = params.M; // required

        validateUint8Arrays({
          M: M
        });
        var M_pointer = AllocatedBuf.fromUint8Array(M, module.crypto_core_ristretto255_BYTES, module);
        pointers.push(M_pointer);
        var sec_pointer = new AllocatedBuf(module.OPAQUE_REGISTER_SECRET_LEN, module);
        pointers.push(sec_pointer);
        var pub_pointer = new AllocatedBuf(module.OPAQUE_REGISTER_PUBLIC_LEN, module);
        pointers.push(pub_pointer);

        if (0 !== module.CreateRegistrationResponse(M_pointer.address, sec_pointer.address, pub_pointer.address)) {
          var error = new Error("CreateRegistrationResponse failed.");
          error.name = "OpaqueError";
          throw error;
        }
        ...
        var _error7 = new Error("createRegistrationResponse failed. (" + e.name + ") " + e.message);

        _error7.name = "OpaqueError";
        _error7.cause = e;
        throw _error7;
      } finally {
        zeroAndFree(pointers);
    ...
    Module["create1kRegistrationResponse"] = function (params) {
      return create1kRegistrationResponse(Module, params);
    };

    Module["Create1kRegistrationResponse"] = Module.cwrap("opaquejs_Create1kRegistrationResponse", "number", ["number", // const uint8_t M[crypto_core_ristretto255_BYTES],
    "number", // const uint8_t pkS[crypto_scalarmult_BYTES],
    "number", // uint8_t sec[OPAQUE_REGISTER_SECRET_LEN],
    "number" // uint8_t pub[OPAQUE_REGISTER_PUBLIC_LEN]);
    ]);
    ...
    function create1kRegistrationResponse(module, params) {
      ...
      try {
        ...
        var M_pointer = AllocatedBuf.fromUint8Array(M, module.crypto_core_ristretto255_BYTES, module);
        pointers.push(M_pointer);
        var pkS_pointer = AllocatedBuf.fromUint8Array(pkS, module.crypto_scalarmult_BYTES, module);
        pointers.push(pkS_pointer);
        var sec_pointer = new AllocatedBuf(module.OPAQUE_REGISTER_SECRET_LEN, module);
        pointers.push(sec_pointer);
        var pub_pointer = new AllocatedBuf(module.OPAQUE_REGISTER_PUBLIC_LEN, module);
        ...
        if (0 !== module.Create1kRegistrationResponse(M_pointer.address, pkS_pointer.address, sec_pointer.address, pub_pointer.address)) {
          var error = new Error("Create1kRegistrationResponse failed.");
          error.name = "OpaqueError";
          throw error;
        }
        ...
        var _error8 = new Error("create1kRegistrationResponse failed. (" + e.name + ") " + e.message);

        _error8.name = "OpaqueError";
        _error8.cause = e;
        throw _error8;
      } finally {
        zeroAndFree(pointers);
    ...
    Module["finalizeRequest"] = function (params) {
      return finalizeRequest(Module, params);
    };

    Module["FinalizeRequest"] = Module.cwrap("opaquejs_FinalizeRequest", "number", ["number", // const uint8_t sec[OPAQUE_REGISTER_USER_SEC_LEN/*+pwdU_len*/],
    ...
    function finalizeRequest(module, params) {
      ...
      try {
        ...
        validatePkgConfig(cfg);
        validateRequiredStrings(ids);
        var sec_pointer = AllocatedBuf.fromUint8ArrayInexact(sec, module.OPAQUE_REGISTER_USER_SEC_LEN
        /*+pwdU_len*/
        , module);
        pointers.push(sec_pointer);
        var pub_pointer = AllocatedBuf.fromUint8Array(pub, module.OPAQUE_REGISTER_PUBLIC_LEN, module);
        pointers.push(pub_pointer);
        var envU_len = module.getEnvelopeLen({
          cfg: cfg,
          ids: ids
        ...
        if (0 !== module.FinalizeRequest(sec_pointer.address, pub_pointer.address, cfg.skU, cfg.pkU, cfg.pkS, cfg.idS, cfg.idU, ids.idU, ids.idU.length, ids.idS, ids.idS.length, rec_pointer.address, export_key_pointer.address)) {
          var error = new Error("FinalizeRequest failed.");
          error.name = "OpaqueError";
          throw error;
        }
        ...
        var _error9 = new Error("finalizeRequest failed. (" + e.name + ") " + e.message);

        _error9.name = "OpaqueError";
        _error9.cause = e;
        throw _error9;
      } finally {
        zeroAndFree(pointers);
    ...
    Module["storeUserRecord"] = function (params) {
      return storeUserRecord(Module, params);
    };

    Module["StoreUserRecord"] = Module.cwrap("opaquejs_StoreUserRecord", null, ["number", // const uint8_t sec[OPAQUE_REGISTER_SECRET_LEN],
    "number" // uint8_t rec[OPAQUE_USER_RECORD_LEN/*+envU_len*/]);
    ]);
    ...
    function storeUserRecord(module, params) {
      ...
      try {
        ...
        var sec_pointer = AllocatedBuf.fromUint8Array(sec, module.OPAQUE_REGISTER_SECRET_LEN, module);
        pointers.push(sec_pointer);
        var rec_pointer = AllocatedBuf.fromUint8ArrayInexact(rec, module.OPAQUE_USER_RECORD_LEN
        /*+envU_len*/
        , module);
        pointers.push(rec_pointer);
        ...
        if (e.name === "OpaqueError") throw e;
        var error = new Error("storeUserRecord failed. (" + e.name + ") " + e.message);
        error.name = "OpaqueError";
        error.cause = e;
        throw error;
      } finally {
    ...
    Module["store1kUserRecord"] = function (params) {
      return store1kUserRecord(Module, params);
    };

    Module["Store1kUserRecord"] = Module.cwrap("opaquejs_Store1kUserRecord", null, ["number", // const uint8_t sec[OPAQUE_REGISTER_SECRET_LEN],
    "number", // const uint8_t skS[crypto_scalarmult_SCALARBYTES],
    "number" // uint8_t rec[OPAQUE_USER_RECORD_LEN/*+envU_len*/]);
    ]);
    ...
    function store1kUserRecord(module, params) {
      ...
      try {
        ...
        var sec_pointer = AllocatedBuf.fromUint8Array(sec, module.OPAQUE_REGISTER_SECRET_LEN, module);
        pointers.push(sec_pointer);
        var skS_pointer = AllocatedBuf.fromUint8Array(skS, module.crypto_scalarmult_SCALARBYTES, module);
        pointers.push(skS_pointer);
        var rec_pointer = AllocatedBuf.fromUint8ArrayInexact(rec, module.OPAQUE_USER_RECORD_LEN
        /*+envU_len*/
        , module);
        pointers.push(rec_pointer);
        module.Store1kUserRecord(sec_pointer.address, skS_pointer.address, rec_pointer.address);
        return {
          rec: rec_pointer.toUint8Array()
        };
      } catch (e) {
        if (e.name === "OpaqueError") throw e;
        var error = new Error("store1kUserRecord failed. (" + e.name + ") " + e.message);
        error.name = "OpaqueError";
        error.cause = e;
        throw error;
      } finally {
    ...
    Module["getEnvelopeLen"] = function (params) {
      return getEnvelopeLen(Module, params);
    };

    Module["envelope_len"] = Module.cwrap("opaquejs_envelope_len", "number", ["number", // const uint8_t cfg_skU,
    "number", // const uint8_t cfg_pkU,
    "number", // const uint8_t cfg_pkS,
    "number", // const uint8_t cfg_idS,
    "number", // const uint8_t cfg_idU,
    ...
    function getEnvelopeLen(module, params) {
      ...
      try {
        var cfg = params.cfg,
            ids = params.ids;
        validateRequiredStrings(ids);
        validatePkgConfig(cfg); // uint32_t has 32 bits = 4 bytes.

        var envU_len_pointer = new AllocatedBuf(4, module);
        pointers.push(envU_len_pointer);

        if (0 !== module.envelope_len(cfg.skU, cfg.pkU, cfg.pkS, cfg.idS, cfg.idU, ids.idU, ids.idU.length, ids.idS, ids.idS.length, envU_len_pointer.address)) {
        ...
        if (e.name === "OpaqueError") throw e;
        var error = new Error("register failed. (" + e.name + ") " + e.message);
        error.name = "OpaqueError";
        error.cause = e;
        throw error;
      } finally {
    ...
    Module["getServerPublicKeyFromUserRecord"] = function (rec_base16) {
      return getServerPublicKeyFromUserRecord(Module, rec_base16);
    };

    Module["server_public_key_from_user_record"] = Module.cwrap("opaquejs_server_public_key_from_user_record", null, ["number", // const uint8_t rec[OPAQUE_USER_RECORD_LEN],
    ...
    function getServerPublicKeyFromUserRecord(module, rec) {
      ...
      try {
        ...
        var rec_pointer = AllocatedBuf.fromUint8Array(rec, module.OPAQUE_USER_RECORD_LEN, module);
        pointers.push(rec_pointer);
        var pkS_pointer = new AllocatedBuf(module.crypto_scalarmult_BYTES, module);
        pointers.push(pkS_pointer);
        module.server_public_key_from_user_record(rec_pointer.address, pkS_pointer.address);
        return {
          pks: pkS_pointer.toUint8Array()
        };
      } catch (e) {
        if (e.name === "OpaqueError") throw e;
        var error = new Error("getServerPublicKeyFromUserRecord failed. (" + e.name + ") " + e.message);
        error.name = "OpaqueError";
        error.cause = e;
        throw error;
      } finally {
    ...
    function getRandomValueFunction() {
      try {
        var window_ = "object" === (typeof window === "undefined" ? "undefined" : _typeof(window)) ? window : self;
        ...
        try {
          ...
          var randomValueNodeJS = function randomValueNodeJS() {
    ...
    function hexToUint8Array(hex, length, array, index) {
      if (length == null && hex.length % 2 === 1) throw new TypeError("The hex string must have a length that is even.");
      var locLength = length != null ? length : hex.length / 2;
      var locArray = array != null ? array : new Array(length);
    ...
    function uint8ArrayToHex(buffer, hex, index) {
      var locBase16String = hex != null ? hex : "";
      var i = index != null ? index : 0;
      if (i >= buffer.length) return locBase16String; // -128 to 127

      var base10SignedByte = buffer[i]; // 0 to 255

      var base10UnsignedByte = base10SignedByte < 0 ? base10SignedByte + 256 : base10SignedByte;
      var base16UnsignedByte = base10UnsignedByte.toString(16);
      var prefix = base16UnsignedByte.length < 2 ? "0" : "";
      return uint8ArrayToHex(buffer, locBase16String + prefix + base16UnsignedByte, i + 1);
    }
  ...
  AllocatedBuf.fromUint8Array = function (array, length, module) {
    if (array.length !== length) throw new TypeError("The Uint8Array must have a length of " + length + ", not " + array.length + ".");
    var buffer = new AllocatedBuf(array.length, module);
    module.HEAPU8.set(array, buffer.address);
    return buffer;
  };

  AllocatedBuf.fromUint8ArrayInexact = function (array, length, module) {
    if (array.length <= length) throw new TypeError("The Uint8Array must have a length of at least " + length + " exclusive, not " + array.length + ".");
    var buffer = new AllocatedBuf(array.length, module);
    module.HEAPU8.set(array, buffer.address);
    return buffer;
  };
  ...
  AllocatedBuf.prototype.toUint8Array = function () {
    ...
    buffer.set(this.module.HEAPU8.subarray(this.address, this.address + this.length));
    return buffer;
  };
  ...
  function validateOptionalStrings(object) {
    for (var _i = 0, _Object$entries = Object.entries(object); _i < _Object$entries.length; _i++) {
      var _Object$entries$_i = _slicedToArray(_Object$entries[_i], 2),
          ...
          string = _Object$entries$_i[1];

      if (string != null && (typeof string !== "string" || string.length < 1)) throw new TypeError("If defined, " + name + " must be a nonempty string.");
    }
  }
  ...
  function validatePkgTarget(cfg, name) {
    if (cfg !== 0 && cfg !== 1 && cfg !== 2) throw new RangeError(name + " (" + cfg + ") must be 0, 1, or 2.");
  }
  ...
  function validateRequiredStrings(object) {
    for (var _i2 = 0, _Object$entries2 = Object.entries(object); _i2 < _Object$entries2.length; _i2++) {
      var _Object$entries2$_i = _slicedToArray(_Object$entries2[_i2], 2),
          ...
          string = _Object$entries2$_i[1];

      if (typeof string !== "string" || string.length < 1) throw new TypeError(name + " must be a nonempty string.");
    }
  }
  ...
  function validateUint8Arrays(object) {
    for (var _i3 = 0, _Object$entries3 = Object.entries(object); _i3 < _Object$entries3.length; _i3++) {
      var _Object$entries3$_i = _slicedToArray(_Object$entries3[_i3], 2),
          ...
          buffer = _Object$entries3$_i[1];

      if (buffer == null) throw new TypeError(name + " must be a Uint8Array, not null.");else if (!(buffer instanceof Uint8Array)) throw new TypeError(name + " must be a Uint8Array.");else if (buffer.length < 1) throw new TypeError(name + " cannot be empty.");
    }
  }
  ...
  function exposeLibopaque(exports) {
    ...
    var functionsInTableMap; // Add a wasm function to the table.

    function addFunctionWasm(func, sig) {
      var table = wasmTable; // Check if the function is already in the table, to ensure each function
      ...
      if (!functionsInTableMap) {
        ...
        for (var i = 0; i < table.length; i++) {
          var item = table.get(i); // Ignore null values.
      ...
      if (freeTableIndexes.length) {
        ...
        ret = table.length; // Grow the table
    ...
    var INITIAL_INITIAL_MEMORY = Module['INITIAL_MEMORY'] || 16777216; // In non-standalone/normal mode, we create the memory here.
    ...
    function _emscripten_resize_heap(requestedSize) {
      ...
      var PAGE_MULTIPLE = 65536; // Memory resize rules:
    ...
    if ((typeof process === "undefined" ? "undefined" : _typeof(process)) === "object" && typeof process.removeAllListeners === "function") {
  ...
  if (typeof define === "function" && define.amd) {
    ...
    root.libopaque = exposeLibopaque(root.libopaque_mod || (root.commonJsStrict = {}));
  }
})(this);
